...
<body>
    ...
    <div class="container">
        <nav class="nav nav-pills nav-fill">
            <a class="nav-link " style="background-color:while; color:darkgreen;" href="./ShopingCart_main.php">商品總覽</a>
            <a class="nav-link"  style="background-color:cornsilk; color:darkgreen;" href="./ShopingCart_check.php">檢視購物車</a>
            <a class="nav-link" style="background-color:while; color:darkgreen;" href="./ShopingOrderDetail.php">結帳</a>
